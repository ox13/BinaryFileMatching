...
rasp_path = "C:\\..\\..\\80_rasp_EMBED_match_ess\\"
rasp_no_match_path = "C:\\..\\..\\80_rasp_EMBED_no_match_ess\\"

# PATH TO ARMHF DOCUMENT VECTOR FILES
armhf_path = 'C:\\..\\..\\80_armhf_EMBED_match_ess\\'
...
class BinaryFileDocvec(object):
    ...
    def load_samples(self,csv_file):
        ...
        """
        function to read a csv file and create a list of samples 
    ...
    def match_coord(self, filename):
            ...
            global counter_plus
            #print(match_counter)
            z =  match_counter[random.randint(0, 99)]
            #counter_plus += 1
            # print(z)
            if z % 2 == 0:
